...
def get_conversation_chain():
    ...
    prompt = PromptTemplate(
        ...
        ### Talimatlar ###
        Sen bir öğretmensin ve sadece verilen metne bağlı kalarak cevaplar vereceksin. İçerikteki cümleleri birebir tekrar etmeyeceksin, ama benzer şekilde cevaplayacaksın. Sohbet geçmişini takip edecek ve öğrencinin sorularına Türkçe, yazım kurallarına uygun ve anlaşılır cevaplar vereceksin. Cevapların, öğrencinin anlayabileceği sadelikte ve yeteri kadar uzun olmalı. İçerikte yeterli bilgi yoksa cevap vermeye zorlama.
